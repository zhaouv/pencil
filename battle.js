// battle.js — Node环境下AI对战测试
// 用法: node battle.js [options]
...
function battle(AI1Cls, AI2Cls, xsize, ysize, rounds) {
    var wins = [0, 0]
    var games = []
...
var r1 = battle(ai1Info.cls, ai2Info.cls, config.xsize, config.ysize, config.rounds)
...
if (config.swap) {
    ...
    var r2 = battle(ai2Info.cls, ai1Info.cls, config.xsize, config.ysize, config.rounds)
